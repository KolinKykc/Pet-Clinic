package com.javaegitimleri.petclinic.dao.mem.jdbc;
...
public class OwnerRepositoryJdbcImpl implements OwnerRepository {
	...
	private org.springframework.jdbc.core.RowMapper<Owner> rowMapper = new org.springframework.jdbc.core.RowMapper<Owner>() {
